...
class EndorsementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endorsement" do
    assert_difference('Endorsement.count') do
      post endorsements_url, params: { endorsement: { approved: @endorsement.approved, descriptor: @endorsement.descriptor, endorsement_message: @endorsement.endorsement_message, name: @endorsement.name } }
    end
  ...
  test "should update endorsement" do
    patch endorsement_url(@endorsement), params: { endorsement: { approved: @endorsement.approved, descriptor: @endorsement.descriptor, endorsement_message: @endorsement.endorsement_message, name: @endorsement.name } }
